...
static const unsigned char CRC8_CODE[] = 
{
...
{
    unsigned char CRC_Temp = CRC8_INIT_VALUE;
    unsigned char CRC_Index = 0;
    unsigned long int i = 0;
    
    for (i = 0; i < iCount; i++) 
    {
        CRC_Index = CRC_Temp ^ pBuf[i];
        CRC_Temp = CRC8_CODE[CRC_Index];
    }
    
    CRC_Temp ^= CRC8_XOR_VALUE;
