...
static uBit32 BS01_GetJson(uBit8 *RecvPack, uBit32 ulRecvLen, uBit8 *JsonPack, uBit32 *pJsonLen)
{
...
/**
  ...
  * @retval 0-成功 非0-失败
  */
uBit32 BS01_InitWifi(uBit8 uUartNode)
{
    uBit32 ulRet = BS01_WIFI_ERR_SUCCESS;
    ...
    do 
    {
        ...
        {
            ulRet = BS01_WIFI_ERR_COM;
            break;
        }
        //设置工作模式
        if (ESP82XX_SetWifiMode(ESP82XX_WIFI_MODE_STA))
        {
            ulRet = BS01_WIFI_ERR_SET;
            break;
        }
...
/**
  ...
  * @retval 0-成功  非0-失败
  */
uBit32 BS01_RecvWeatherPack(uBit8 *pJsonPack, uBit32 *pJsonLen)
{
    uBit32 ulEnetStatus = 0;
    uBit32 ulRet = 0;
    ...
    do 
    {
        ...
        if (BS01_GetJson(uRecvBuff, ulRecvLen, pJsonPack, pJsonLen))
        {
            ulRet = 1;
            break;
        }
...
/**
  ...
  * @retval 0-成功  非0-失败
  */
uBit32 BS01_RecvClockPack(uBit8 *pJsonPack, uBit32 *pJsonLen)
{
    uBit32 ulEnetStatus = 0;
    uBit32 ulRet = 0;
    uBit8  uRecvBuff[512] = {0};
