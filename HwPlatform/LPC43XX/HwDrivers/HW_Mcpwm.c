/**
  ...
  * 引脚,
  *     MCABORT --- P[]  FUNC
  *     MCOA[0] --- P4[0]  FUNC1   P9[3]  FUNC1
  *     MCOB[0] --- P5[4]  FUNC1   P9[4]  FUNC1
  *     MCOA[1] --- P5[5]  FUNC1   P9[5]  FUNC1
  *     MCOB[1] --- P5[6]  FUNC1   P9[6]  FUNC1
  *     MCOA[2] --- P5[7]  FUNC1   P9[1]  FUNC1
  *     MCOB[2] --- P5[0]  FUNC1   P9[2]  FUNC1
  *     
  *     MCI[0]  --- P5[3]  FUNC1   P8[2]  FUNC3
  *     MCI[1]  --- P5[2]  FUNC1   P8[1]  FUNC3
  *     MCI[2]  --- P5[1]  FUNC1   P8[0]  FUNC3
  *     
...
{
#if 1
    {0x04,  0, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOA[0]
    {0x05,  4, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOB[0]
    {0x05,  5, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOA[1]
    {0x05,  6, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOB[1]
    {0x05,  7, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOA[2]
    {0x05,  0, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOB[2]
#else
    {0x09,  3, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOA[0]
    {0x09,  4, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOB[0]
    {0x09,  5, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOA[1]
    {0x09,  6, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOB[1]
    {0x09,  1, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOA[2]
    {0x09,  2, SCU_MODE_INACT | SCU_MODE_FUNC1},    //MCOB[2]
#endif
...
{
#if 1
    {0x05,  3, SCU_MODE_INACT | SCU_MODE_FUNC1},   //MCI[0]
    {0x05,  2, SCU_MODE_INACT | SCU_MODE_FUNC1},   //MCI[1]
    {0x05,  1, SCU_MODE_INACT | SCU_MODE_FUNC1},   //MCI[2]
#else
    {0x08,  2, SCU_MODE_INACT | SCU_MODE_FUNC3},   //MCI[0]
    {0x08,  1, SCU_MODE_INACT | SCU_MODE_FUNC3},   //MCI[1]
    {0x08,  0, SCU_MODE_INACT | SCU_MODE_FUNC3},   //MCI[2]
#endif
...
/**
  ...
  * @param  bOppositeOutput 是否使能MCOB反相输出引脚
  * @retval None
  */
static void HW_MCPWM_ConfigOutputIO(uint8_t uMcpwmNode, bool bOppositeOutput)
{
    //使能MCOA[x]
    Chip_SCU_SetPinMuxing(&m_McpwmOutputPinMux[uMcpwmNode*2], 1);

    if (bOppositeOutput)
    {
        //使能MCOB[x]
        Chip_SCU_SetPinMuxing(&m_McpwmOutputPinMux[uMcpwmNode*2 + 1], 1);
    }
...
{
    //使能MCI[x]
    Chip_SCU_SetPinMuxing(&m_McpwmInputPinMux[uMcpwmNode*2], 1);
...
uint32_t HW_MCPWM_InitOutput(uint8_t uMcpwmNode, bool bOppositeOutput)
{
    ...
    //获取外设时钟频率
    ulMcpwmClockRate = Chip_Clock_GetRate(CLK_APB1_MOTOCON);
...
void HW_MCPWM_SetOutputPwmFrq(uint8_t uMcpwmNode, uint32_t ulFrequency)
{
    ...
    //获取外设时钟频率
    uint32_t ulMcpwmClockRate = Chip_Clock_GetRate(CLK_APB1_MOTOCON);
...
uint32_t HW_MCPWM_InitInputCount(uint8_t uMcpwmNode, uint8_t uInputSource, uint8_t uTrgSource)
{
    ...
    //开时钟
    Chip_Clock_GetRate(CLK_APB1_MOTOCON);
