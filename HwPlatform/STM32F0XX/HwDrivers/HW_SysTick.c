...
/**
  ...
  * @retval None
  */
void HW_SysTick_SetTickTime(uint32_t ulTickTime)
{
...
/**
  ...
  */
uint32_t HW_SysTick_GetCount(void)
{
...
/**
  ...
  * @retval None
  */
void HW_SysTick_Init(uint32_t ulTickTime)
{
    //更新系统内核时钟
    ...
    //设置系统滴答中断回调
    HW_IRQ_SetTrgCallback(HW_SysTick_Update, STM32F0_IRQ_TRG_SYSTICK_UPDATE);
